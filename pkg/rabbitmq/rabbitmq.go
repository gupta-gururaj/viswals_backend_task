...
func (r *RabbitMQ) Subscribe(ctx context.Context) (<-chan amqp.Delivery, error) {
	consume, err := r.channel.ConsumeWithContext(ctx,r.queue.Name, "", true, false, false, false, nil)
	if err != nil {
		return nil, err
	}
